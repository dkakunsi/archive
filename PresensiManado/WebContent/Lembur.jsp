...
<title>Data Lembur - Sistem Presensi</title>
</head>

<body>
	<%@ page import="edu.dkakunsi.ta.presensi.model.entity.Lembur" %>
    ...
    <div id="container">
	    ...
	    <div id="table">
        	...
        	<table>
		    	...
		    	<% @SuppressWarnings("unchecked") List<Lembur> ls = (List<Lembur>)request.getAttribute("rsp"); %>
		    	<% for(Lembur l : ls) { %>
	        		<tr>
    	    		    <td><%= l.getId().getNip() %></td>
        	  			<td><%= l.getPresensi().getPegawai().getNama() %></td>
    	    		    <td><%= l.getId().getTanggal() %></td>
          				<td><%= l.getJumlah() %></td>
       		    	</tr>
				<% } %>
   		  </table>
